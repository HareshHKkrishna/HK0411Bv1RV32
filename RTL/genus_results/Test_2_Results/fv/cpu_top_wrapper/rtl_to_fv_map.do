...
# Generated on: Tue Jun 23 07:36:19 IST 2026 (Tue Jun 23 02:06:19 UTC 2026)
...
set logfile fv/cpu_top_wrapper/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/cpu_top_wrapper -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86"
set env(CW_DIR) "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
add_search_path . /tools/cadence/installs/DDI251/GENUS251/tools.lnx86/lib/tech -library -both
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 -f rtl.f
elaborate_design -golden -root {cpu_top_wrapper} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/cpu_top_wrapper/fv_map.v.gz
elaborate_design -revised -root {cpu_top_wrapper}
...
add_black_box data_memory instruction_memory -golden
...
set_analyze_option -mapping_file fv/cpu_top_wrapper/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.cpu_top_wrapper.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.cpu_top_wrapper.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.cpu_top_wrapper.rtl.fv_map.rpt
